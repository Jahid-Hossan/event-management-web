...
const Banner2 = () => {
    ...
    return (
        <div data-aos="zoom-in" className='md:flex items-center container mx-auto justify-around px-5 my-5 md:my-10 lg:my-14 '>

            <div data-aos="zoom-in" className='text-center md:text-left my-5 md:w-1/2'>
